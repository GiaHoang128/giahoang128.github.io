//+------------------------------------------------------------------+
//|                                                   XAUUSD EA.mq5 |
//|                           XAUUSD TrendScalp with ATR Risk Guard |
...
#property strict
#property description "Trend-following scalper for XAUUSD with ATR-based entries, trailing, breakeven, and daily equity guard."
...
//============================= Notes ===============================//
// Recommended usage:
// - Attach to XAUUSD M5 chart. Inputs default for trend-following scalping.
// - Cent account: start with Risk_Per_Trade_Pct <= 1.0 and consider widening SL_ATR_Mult if volatility spikes.
// - Use broker with tight spreads on XAUUSD and fast execution.
// - Always forward-test on demo before live usage. Past performance does not guarantee future results.
// - No EA can guarantee daily profit or capital safety; adjust risk to your tolerance.
//+------------------------------------------------------------------+
